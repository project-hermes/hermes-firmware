...
#define MIN_DEPTH_VALID_DIVE -10        /* Min depth to validate dynamic dive (meters)*/
...
#define MAX_DYNAMIC_COUNTER_VALID_DIVE 5 /* Number of No Water to end dynamic dive (TIME_DYNAMIC_MODE / 1000 * MAX_DYNAMIC_COUNTER = seconds)*/
#define MAX_DYNAMIC_COUNTER_NO_DIVE 5   /* Number of No Water to end dynamic dive (TIME_DYNAMIC_MODE / 1000 * MAX_DYNAMIC_COUNTER = seconds)*/
